...
public class AllTestsSuite {
    public static Test suite() {
        ...
        suite.addTest(com.xversial.mysql.management.util.AllTestsSuite.suite());
        suite
                .addTest(com.xversial.mysql.management.driverlaunched.AllTestsSuite
                        .suite());

        suite.addTestSuite(HelpOptionsParserTest.class);

        suite.addTest(com.xversial.mysql.management.jmx.AllTestsSuite.suite());

        // slow tests:
        suite.addTestSuite(MysqldResourceTest.class);
        suite.addTestSuite(AcceptanceTest.class);
        suite
                .addTestSuite(com.xversial.mysql.management.driverlaunched.AcceptanceTest.class);
